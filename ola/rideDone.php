  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item">
        <?php  
            ...
            echo "Final Amount(After having tip amount): ". $_SESSION['finalPresentAmount'];
        ?>
    </li>
    <li class="list-group-item">
        <?php  
    ...
    <form action="" method="post">
        ...
        <input type="submit" name="ppa" value="Pay Present Amount"/>
    </form>
    <?php
        if(isset($_POST['pta']) || isset($_POST['ppa'])){
            if(isset($_POST['pta'])){
                ...
                $_SESSION['pmoney'] = $_SESSION['finalpAmount'];
            }
